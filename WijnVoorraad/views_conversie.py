...
class StartConversieView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        conv_druivensoorten = te_conv_deelnemers()
        context["aantal_deelnemers_te_conv"] = conv_druivensoorten.count()
        ...
        conv_druivensoorten = te_conv_druivensoorten()
        context["aantal_druivensoorten_te_conv"] = conv_druivensoorten.count()
